...
module.exports = function(defaults) {
  ...
  */
  ...
  return require('@embroider/compat').compatBuild(app, Webpack, {
    ...
    packagerOptions: {
      entry: {
        head: path.join(__dirname, 'node_modules','.embroider', 'rewritten-app', 'assets', 'vendor.js')
      },
      webpackConfig: {
        plugins: [
          new HtmlWebpackPlugin({
            ...
            template: '!!' + require.resolve('html-webpack-plugin/lib/loader') + '?force=true!' + require.resolve('./ember-html-loader') + '!' + path.resolve(__dirname, 'node_modules','.embroider', 'rewritten-app', 'index.html')
          }),
          new HtmlWebpackPlugin({
            filename: 'test.html',
            chunks: [
