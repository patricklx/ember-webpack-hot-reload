...
import { Resolver as EmbroiderResolver, type ResolverOptions as EmbroiderResolverOptions } from '@embroider/core';
import type { Compiler, Module } from 'webpack';
import assertNever from 'assert-never';
import escapeRegExp from 'escape-string-regexp';

export type { EmbroiderResolverOptions as Options };
